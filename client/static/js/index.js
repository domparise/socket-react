...
var CounterSet = React.createClass({displayName: "CounterSet",
    ...
    render: function () {
        ...
        for (var i = 0; i < this.props.num; i++) {
            counters.push(
                React.createElement(OuterCounter, {background_color: colors[i%3], text_color: colors[(i+1)%3], incrementParent: this.handleClick, key: i})
            );
        }
...
},{"./OuterCounter.jsx":3,"react":161}],2:[function(require,module,exports){
var React = require('react')
var InnerCounter = React.createClass({displayName: "InnerCounter",
    getInitialState: function () {
        return {
            count: 0
        }
    ...
    render: function () {
        return (
            React.createElement("div", null, 
                ...
                React.createElement("button", {onClick: this.handleClick}, "Inner")
            )
        );
    }
});
...
var OuterCounter = React.createClass({displayName: "OuterCounter",
    getInitialState: function () {
        return {
            count: 0
        };
    ...
    render: function() {
        return (
            React.createElement("div", {className: "OuterCounter", style: {backgroundColor:this.props.background_color,color:this.props.text_color}}, 
                React.createElement("p", null, this.state.count), 
                React.createElement("button", {onClick: this.handleClick}, "Outer"), 
                React.createElement(InnerCounter, {incrementParent: this.handleClick})
            )
        );
    }
});
module.exports = OuterCounter;
},{"./InnerCounter.jsx":2,"react":161}],4:[function(require,module,exports){
var React = require('react');
...
},{"./CounterSet.jsx":1,"./home.jsx":4}],6:[function(require,module,exports){
...
},{"./components/index.jsx":5}],7:[function(require,module,exports){
/**
